...
\lhead{COMS100011 8\_continuous\_random - Conor}
\begin{document}
...
It is useful to note that these properties can be used to see how the mean and variance change under simple linear transformations. With the obvious notation let $Y=X=c$, then
\begin{equation}
